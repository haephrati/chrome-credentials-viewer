...
// Based on the following article https://www.codeproject.com/Articles/1383/CTabCtrlSSL-An-easy-to-use-flexible-extended-tab-c
// with several enhancements we have done
...
#define TAB_CHANGE_MSG     (WM_USER + 84)
...
//	::SendMessage(pDialog->m_hWnd ,WM_ACTIVATE,WA_ACTIVE, NULL);
	::SendMessage(pDialog->m_hWnd ,TAB_CHANGE_MSG,NULL, NULL);
